...
const merchant_quote_controller_1 = require("./merchant-quote.controller");
...
exports.MerchantModule = MerchantModule = __decorate([
    (0, common_1.Module)({
        controllers: [merchant_controller_1.MerchantController, merchant_quote_controller_1.MerchantQuoteController],
